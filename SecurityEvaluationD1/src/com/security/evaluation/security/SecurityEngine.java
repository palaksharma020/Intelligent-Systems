package com.security.evaluation.security;
...
public class SecurityEngine {
	...
	public Iterator<Evaluation> run(ImpactEvaluation impEvalObj)
	...
	public Iterator<Evaluation> run(VulnEffEvaluation vulEffObj)
			throws JessException {
		// Remove any previous order data, leaving only current data
		engine.resetToMark(marker);
